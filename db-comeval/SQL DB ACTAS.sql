...
SELECT s.* FROM solicitud s WHERE s.solicitud in (23893, 23894, 23889, 23891, 23890, 23892, 23895, 23896, 23897, 23898, 23899, 23900, 23901);
SELECT ss.* FROM solicitud_solicitante ss WHERE ss.solicitud IN (23893, 23894, 23889, 23891, 23890, 23892, 23895, 23896, 23897, 23898, 23899, 23900, 23901);
SELECT sc.* FROM solicitud_contenido sc WHERE sc.solicitud IN (23893, 23894, 23889, 23891, 23890, 23892, 23895, 23896, 23897, 23898, 23899, 23900, 23901);
