    ...
    public String cambio_horario_ingresar(String jsonString) {
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_cambio_horario.size(); i++) {
                ...
                if (lst_comeval_cambio_horario.get(i).getNota_ref().equals("-")) {
                    nota_ref_temp = "null";
                } else {
                    nota_ref_temp = "'" + lst_comeval_cambio_horario.get(i).getNota_ref() + "'";
                }

                String fecha_nota_ref_temp;
                if (lst_comeval_cambio_horario.get(i).getFecha_nota_ref().equals("-")) {
                    fecha_nota_ref_temp = "null";
                } else {
                    fecha_nota_ref_temp = "'" + lst_comeval_cambio_horario.get(i).getFecha_nota_ref() + "'";
                }

                cadenasql = "insert into comeval_cambio_horario ("
                        + "id_comeval_cambio_horario, "
                        + "personal, "
                        + "id_tipo_cambio_horario, "
                        + "nota_ref, "
                        + "fecha_nota_ref, "
                        + "usuario, "
                        + "fecha_ingreso, "
                        ...
                        + lst_comeval_cambio_horario.get(i).getId_tipo_cambio_horario() + ","
                        + nota_ref_temp + ","
                        + fecha_nota_ref_temp + ",'"
                        + lst_comeval_cambio_horario.get(i).getUsuario() + "','"
                        ...
                        + "null" + ","
                        + "null" + ","
                        + lst_comeval_cambio_horario.get(i).getVisto_bueno_director_escuela() + ","
                ...
                for (Integer j = 0; j < lst_comeval_cambio_horario.get(i).getLst_horario_plaza().size(); j++) {
                    cadenasql = "insert into comeval_cambio_horario_plaza ("
                            ...
                            + lst_comeval_cambio_horario.get(i).getLst_horario_plaza().get(j).getNumero_plaza() + ")";
                    stmt = this.conn.createStatement();
                    stmt.executeUpdate(cadenasql);
                    stmt.close();
                }

                for (Integer j = 0; j < lst_comeval_cambio_horario.get(i).getLst_observaciones().size(); j++) {
                    cadenasql = "insert into comeval_solicitud_observacion ("
                            ...
                            + "observacion) values ("
                            + id_comeval_cambio_horario + ","
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getId_tipo_solicitud() + ","
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getId_observacion() + ",'"
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getDependencia() + "','"
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getFecha_hora() + "','"
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getObservacion() + "')";
                    stmt = this.conn.createStatement();
                    stmt.executeUpdate(cadenasql);
                    stmt.close();
                }
                ...
                cadenasql = "select coalesce(max(t.id_workflow) + 1, 1) max_id from solicitud_workflow_historial t where t.id_solicitud=" + id_comeval_cambio_horario;
                stmt = this.conn.createStatement();
                ...
                solicitud_workflow_historial.setUsuario(lst_comeval_cambio_horario.get(i).getUsuario());
            ...
            resultado = "0,Solicitud Cambio de Horario ingresada correctamente.";
        } catch (Exception ex) {
            try {
                this.conn.rollback();
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_ingresar-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_ingresar-1):" + ex.toString();
            }
        } finally {
    ...
    public String cambio_horario_modificar(String jsonString) {
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_cambio_horario.size(); i++) {
                ...
                if (lst_comeval_cambio_horario.get(i).getRechazado() == Long.parseLong("1")) {
                    id_estado_solicitud_rechazado_temp = lst_comeval_cambio_horario.get(i).getId_estado_solicitud_rechazado().toString();
                    id_tipo_solicitud_rechazado_temp = lst_comeval_cambio_horario.get(i).getId_tipo_solicitud_rechazado().toString();
                } else {
                ...
                String cadenasql = "update comeval_cambio_horario set "
                        + "id_tipo_cambio_horario=" + lst_comeval_cambio_horario.get(i).getId_tipo_cambio_horario() + ", "
                        + "nota_ref=" + nota_ref_temp + ", "
                        + "fecha_nota_ref=" + fecha_nota_ref_temp + ", "
                        + "usuario='" + lst_comeval_cambio_horario.get(i).getUsuario() + "', "
                        ...
                        + "visto_bueno_director_escuela=" + lst_comeval_cambio_horario.get(i).getVisto_bueno_director_escuela() + ", "
                ...
                cadenasql = "delete from comeval_solicitud_observacion "
                        + "where id_solicitud=" + lst_comeval_cambio_horario.get(i).getId_comeval_cambio_horario() + " and "
                ...
                for (Integer j = 0; j < lst_comeval_cambio_horario.get(i).getLst_observaciones().size(); j++) {
                    cadenasql = "insert into comeval_solicitud_observacion ("
                            ...
                            + "fecha_hora, "
                            + "observacion) values ("
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getId_solicitud() + ","
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getId_tipo_solicitud() + ","
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getId_observacion() + ",'"
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getDependencia() + "','"
                            + lst_comeval_cambio_horario.get(i).getLst_observaciones().get(j).getFecha_hora() + "','"
            ...
            resultado = "0,Solicitud Cambio de Horario modificada correctamente.";
        } catch (Exception ex) {
            try {
                this.conn.rollback();
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_modificar-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_modificar-1):" + ex.toString();
            }
        } finally {
            this.Cerrar_Conexion();
        }
    ...
    public String cambio_horario_enviar_ingreso_docente(String jsonString) {
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_cambio_horario.size(); i++) {
                ...
                if (validado) {
                    ...
                    String cadenasql = "select "
                            ...
                            + "where "
                            + "ws.id_estado_solicitud_actual=" + lst_comeval_cambio_horario.get(i).getId_estado_solicitud() + " and "
                            + "ws.id_tipo_solicitud_actual=" + lst_comeval_cambio_horario.get(i).getId_tipo_solicitud();
                    Statement stmt = this.conn.createStatement();
                    ResultSet rs = stmt.executeQuery(cadenasql);
                    while (rs.next()) {
                    ...
                    if (!id_estado_solicitud_siguiente.equals(Long.parseLong("0")) && !id_tipo_solicitud_siguiente.equals(Long.parseLong("0"))) {
                        cadenasql = "update comeval_cambio_horario set "
                                + "id_estado_solicitud=" + id_estado_solicitud_siguiente + ", "
                                + "id_tipo_solicitud=" + id_tipo_solicitud_siguiente + ", "
                                + "usuario='" + lst_comeval_cambio_horario.get(i).getUsuario() + "' "
                                + "where id_comeval_cambio_horario=" + lst_comeval_cambio_horario.get(i).getId_comeval_cambio_horario();
                        stmt = this.conn.createStatement();
                        stmt.executeUpdate(cadenasql);
                        stmt.close();

                        Long max_id_workflow = Long.parseLong("0");
                        cadenasql = "select coalesce(max(t.id_workflow) + 1, 1) max_id from solicitud_workflow_historial t where t.id_solicitud=" + lst_comeval_cambio_horario.get(i).getId_comeval_cambio_horario();
                        stmt = this.conn.createStatement();
                        rs = stmt.executeQuery(cadenasql);
                        while (rs.next()) {
                            max_id_workflow = rs.getLong(1);
                        ...
                        resultado = "0,Solicitud Cambio de Horario enviada al siguiente estado correctamente.";
                    } else {
                        resultado = "1,No existe estado siguiente para la solicitud Cambio de Horario.";
                    }
                } else {
            ...
            try {
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_ingreso_docente-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_ingreso_docente-1):" + ex.toString();
            }
        } finally {
            this.Cerrar_Conexion();
        }
    ...
    public String cambio_horario_enviar_visto_bueno_escuela(String jsonString) {
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_cambio_horario.size(); i++) {
                if (lst_comeval_cambio_horario.get(i).getRechazado() == Long.parseLong("1")) {
                    String cadenasql = "update comeval_cambio_horario set "
                            + "id_estado_solicitud=" + lst_comeval_cambio_horario.get(i).getId_estado_solicitud_rechazado() + ", "
                            + "id_tipo_solicitud=" + lst_comeval_cambio_horario.get(i).getId_tipo_solicitud_rechazado() + ", "
                            + "usuario='" + lst_comeval_cambio_horario.get(i).getUsuario() + "', "
                            + "rechazado=0, "
                    ...
                    cadenasql = "insert into solicitud_workflow_historial ("
                            ...
                            + "fecha_rechazado) values ("
                            + lst_comeval_cambio_horario.get(i).getId_comeval_cambio_horario() + ","
                            + lst_comeval_cambio_horario.get(i).getId_estado_solicitud_rechazado() + ","
                            + lst_comeval_cambio_horario.get(i).getId_tipo_solicitud_rechazado() + ","
                            + max_id_workflow + ",'"
                            + lst_comeval_cambio_horario.get(i).getUsuario() + "','"
                            + dateFormat.format(fecha_actual) + "',"
                            + lst_comeval_cambio_horario.get(i).getRechazado() + ",'"
                    ...
                    resultado = "0,Solicitud Cambio Horario rechazada correctamente.";
                } else {
                    ...
                    String cadenasql = "select cch.visto_bueno_director_escuela "
                            ...
                            + "where "
                            + "cch.id_comeval_cambio_horario=" + lst_comeval_cambio_horario.get(i).getId_comeval_cambio_horario();
                    Statement stmt = conn.createStatement();
                    ResultSet rs = stmt.executeQuery(cadenasql);
                    ...
                    if (visto_bueno_director_escuela == 0) {
                        validado = false;
                        mensaje_no_valido = "Debe marcar la casilla Visto_Bueno (Escuela) en el formulario de la solicitud Cambio Horario.";
                    } else {
                        validado = true;
                    }
                    ...
                    if (validado) {
                        ...
                        if (!id_estado_solicitud_siguiente.equals(Long.parseLong("0")) && !id_tipo_solicitud_siguiente.equals(Long.parseLong("0"))) {
                            ...
                            resultado = "0,Solicitud Cambio Horario enviada al siguiente estado correctamente.";
                        } else {
                            resultado = "1,No existe estado siguiente para la solicitud Cambio Horario.";
                        }
                    } else {
                        resultado = "1," + mensaje_no_valido;
                    }
            ...
            try {
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_visto_bueno_escuela-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_visto_bueno_escuela-1):" + ex.toString();
            }
        } finally {
            this.Cerrar_Conexion();
        }
    ...
    public String cambio_horario_enviar_visto_bueno_secretario(String jsonString) {
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_cambio_horario.size(); i++) {
                if (lst_comeval_cambio_horario.get(i).getRechazado() == Long.parseLong("1")) {
                    ...
                    if (validado) {
                        ...
                        String nombre_solicitante = ctrl_driver1.nombre_usuario(lst_comeval_cambio_horario.get(i).getUsuario());

                        cadenasql = "select p.nombre "
                                + "from puesto p "
                                + "where p.puesto in (select t.puesto from titularidad t where t.personal='" + lst_comeval_cambio_horario.get(i).getUsuario() + "')";
                        stmt = this.conn.createStatement();
                        rs = stmt.executeQuery(cadenasql);
                        ...
                        fecha_nota_ref.setTime(dateFormat.parse(lst_comeval_cambio_horario.get(i).getFecha_nota_ref()));
                        ...
                        cadenasql = "select p.personal, trim(p.nombre) || ' ' || trim(p.apellido) nombre_solicitante "
                                + "from personal p "
                                + "where p.personal='" + lst_comeval_cambio_horario.get(i).getPersonal() + "'";
                        stmt = this.conn.createStatement();
                        rs = stmt.executeQuery(cadenasql);
                        ...
                        solicitud_acta.setSolicitanteexterno("NOMBRE-SOLICITANTE: " + nombre_solicitante + ", CÓDIGO-PERSONAL: " + lst_comeval_cambio_horario.get(i).getUsuario());
                        solicitud_acta.setDescripcion("Se recibió nota de Ref. " + lst_comeval_cambio_horario.get(i).getNota_ref().trim() + " de fecha " + l_dia_fecha_nota_ref + " de " + l_mes_fecha_nota_ref + " de " + anio_fecha_nota_ref + ", "
                                + "enviada por el Ing(a). " + nombre_solicitante.trim() + ", " + puesto_solicitante.trim() + " de la Facultad de Ingeniería, "
                                + "quien presenta Solicitud Cambio de Horario del docente del ingeniero/a " + nombre_docente + " con registro de personal No. " + lst_comeval_cambio_horario.get(i).getPersonal() + ", ");

                        String id_archivo_personal2 = "";
                        Ctrl_Driver ctrl_driver2 = new Ctrl_Driver("jndi_asuntosestudiantiles");
                        Long id_solicitud = ctrl_driver2.insertar_solictid_db_actas(solicitud_acta, lst_comeval_cambio_horario.get(i).getUsuario(), nombre_solicitante, id_archivo_personal2, Long.parseLong("50"));
            ...
            try {
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_visto_bueno_secretario-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_enviar_visto_bueno_secretario-1):" + ex.toString();
            }
        } finally {
            this.Cerrar_Conexion();
        }
        ...
        try {
            ...
            for (Integer i = 0; i < lst_comeval_acta_solicitud.size(); i++) {
                ...
                if (acuerdo_acta.getTiene_contenido()) { // SI NO TINE CONTENIDO NO SE REALIZA NINGUNA ACCIÓN.
                    ...
                    // CAMBIO DE ESTADO DE LA SOLICITUD CAMBIO HORARIO.
                    ...
                    cadenasql = "select "
                            ...
                            + "cad.usuario "
                            + "from "
                            + "comeval_cambio_horario cad "
                            + "where "
                            + "cad.id_comeval_cambio_horario=" + lst_comeval_acta_solicitud.get(i).getId_solicitud();
                    stmt = this.conn.createStatement();
                    rs = stmt.executeQuery(cadenasql);
                    while (rs.next()) {
                    ...
                    if (!id_estado_solicitud_siguiente.equals(Long.parseLong("0")) && !id_tipo_solicitud_siguiente.equals(Long.parseLong("0"))) {
                        cadenasql = "update comeval_cambio_horario set "
                                ...
                                + "id_tipo_solicitud=" + id_tipo_solicitud_siguiente + ", "
                                + "usuario='" + usuario + "' "
                                + "where id_comeval_cambio_horario=" + lst_comeval_acta_solicitud.get(i).getId_solicitud();
                        stmt = this.conn.createStatement();
                        stmt.executeUpdate(cadenasql);
                        stmt.close();
            ...
            try {
                ...
                System.out.println("1,ERROR (" + this.getClass().getName() + " - cambio_horario_acta_junta_directiva-1):" + ex.toString());
                resultado = "1,ERROR (" + this.getClass().getName() + " - cambio_horario_acta_junta_directiva-1):" + ex.toString();
            }
        } finally {
            this.Cerrar_Conexion();
        }
